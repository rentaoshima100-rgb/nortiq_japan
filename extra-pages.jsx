...
const LEGAL_DATA = {
  privacy: {
    ...
    // LegalPage はこの値を「制定日 / 改定日: 」(ヒーロー) と「制定: 」(末尾) の両方に前置きする。
    // 「制定: 2026年4月1日 制定 / …」と読まれないよう、制定日を先頭に置き改定日は括弧で添える。
    updated: "2026年4月1日（2026年9月22日 改定）",
    sections: [
