...
Google Search CentralのCore Web Vitals[公式ドキュメント](https://web.dev/articles/vitals)によると、Googleが「良好」と定める基準値は以下のとおりです。この基準はGoogleが2021年6月に検索ランキングシグナルとして正式採用しています。
